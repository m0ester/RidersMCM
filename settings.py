...
defaultRevision = 'NTSC 1.00' # Should follow the revision string convention of "[region] [version]"
...
customCodeRegions = OrderedDict([
	...
	( 'NTSC 1.00|Tournament Mode Region', [ ( 0x123D00, 0x131E00 ) ] ), 	# Total space: 0xA024
	...
	( 'NTSC 1.00|Aux Code Regions', [ ( 0x1036A0, 0x103F64 ) ] ), #Total space: 0x8C4
